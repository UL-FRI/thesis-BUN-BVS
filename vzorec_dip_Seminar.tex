...
% verzija 1. september 2020 (seznam literature v slovenščini, Jakob Maležič in Nejc Ilc)
...
\usepackage[style=trad-plain]{biblatex}  % omogoči seznam literature v slovenščini; če želimo vrstni red glede na zaporedje citiranja, dodamo opcijo sorting=none, torej [style=trad-plain, sorting=none]
\addbibresource{literatura.bib}          % pot do datoteke BiBTeX z literaturo
\usepackage{csquotes} 
