...
Lega plovke v končnem izdelku ni pogojena s tekom besedila, temveč z izgledom strani. 
...
Tabele je najbolje oblikovati kar neposredno v \LaTeX u, saj za oblikovanje tabel obstaja zelo fleksibilno okolje \texttt{tabular}, sicer pa za stavljenje tabel priporočamo ogled predstavitve na \url{https://people.inf.ethz.ch/markusp/teaching/guides/guide-tables.pdf}, ki meddrugim svetuje, katere črte naj tabele vsebujejo in katere ne. Odsvetuje se na primer uporaba vertikalnih črt.
...
V  dokument \LaTeX\ lahko vključimo slike različnih zapisov, tako
bitne kot vektorske slike. Najbolj primerne so slike v zapisu {\tt .pdf}, saj je tudi samo oblikovano besedilo v tem formatu. Če vključujete fotografije, uporabite slike v zapisu {\tt .jpeg}. Slika~\ref{pic1} je npr. v formatu {\tt .jpeg}. Za zaslonske izrise uporabljajte slike z brezizgubno kompresijo, najbolje v zapisu {\tt .png}.
...
Podnapisi slik so pod slikami, tabel pa nad tabelami.

Če slike povzamemo iz drugih virov, potem se moramo v podnapisu k taki sliki sklicevati na ta vir! Slike iz drugih virov vključujte le, če ste za te pridobili dovoljenje založnika, slike iz spletnih virov pa le, če so te objavljene pod licenco, ki dovoljuje vključevanje slik v druga tiskana gradiva. 

Slike naj imajo oznake v jeziku diplomske naloge. Če pišete diplomsko nalogo v slovenščini, naj bodo oznake na slikah v tem jeziku.
